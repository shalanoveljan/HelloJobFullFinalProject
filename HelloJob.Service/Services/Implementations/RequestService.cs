            ...
            var RequestGetDtos = paginatedRequests.Datas.Select(x =>
               new RequestGetDto
               {
                   ...
                   Resume = new ResumeGetDto
                   {
                       ...
                       Category = new CategoryGetDto { Id = x.Resume.Category.Id, Name = x.Resume.Category.Name, Image = x.Resume.Category.Image, ParentId = x.Resume.Category.ParentId },
                   ...
                   Vacancy = new VacancyGetDto
                   {
                       ...
                       Company = new CompanyGetDto { Id = x.Vacancy.Company.Id, About = x.Vacancy.Company.About, Email = x.Vacancy.Company.Email, Image = x.Vacancy.Company.Image, Name = x.Vacancy.Company.Name, WebsiteUrlLink = x.Vacancy.Company.WebsiteUrlLink, order = x.Vacancy.Company.order, AppUser = x.Vacancy.Company.AppUser },
                       Category = new CategoryGetDto { Id = x.Vacancy.Category.Id, Name = x.Vacancy.Category.Name, Image = x.Vacancy.Category.Image, ParentId = x.Vacancy.Category.ParentId },
                       City = new CityGetDto { Id = x.Vacancy.City.Id, Name = x.Vacancy.City.Name, CreateAt = x.Vacancy.City.CreatedAt },
                   }
               }).ToList();
