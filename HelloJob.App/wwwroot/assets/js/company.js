var modeBtn=document.querySelector('.mode_btn_company')
var mode=document.getElementById('body-company')
...
const nightmenuacButonu = document.querySelector('.menu_open_night');
